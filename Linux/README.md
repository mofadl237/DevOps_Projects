...
لأن passwd يقدر أي مستخدم يقرأه.
...
لو نسيتها ممكن تشيل المستخدم من باقي المجموعات.

ودي من أشهر أخطاء المبتدئين.
...
✅ shadow يحتوي الباسورد المشفر

---

❌ Root اسمه root فقط

✅ Root هو أي User يمتلك UID=0

---

❌ useradd و adduser نفس الشيء

✅ adduser مجرد Script فوق useradd
...
يعني تقدر تشوف الشقة.

---

Write

يعني تقدر تغير العفش.

---

Execute

يعني تملك مفتاح الدخول.
...
بتغير العفش بس مش معاك مفتاح تدخل.
...
يطلب من البرنامج الإغلاق بشكل طبيعي.

---

## SIGKILL (9)

إجبار العملية على التوقف.
...
Linux يسمح بتشغيل البرامج بالخلفية.
